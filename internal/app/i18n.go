...
var messages = map[locale]map[MessageKey]string{
	localeEN: {
		...
		MsgInstalledContentChanged: "Installed content differs from current package, reinstalling...",
	...
	localeKO: {
		...
		MsgInstalledContentChanged: "설치된 앱 내용이 현재 패키지와 달라 다시 설치합니다...",
